package dev.shxzu.valium.gui.clickgui.old.components;

import dev.shxzu.valium.gui.clickgui.old.Window;
import dev.shxzu.valium.gui.clickgui.old.components.settings.*;
