...
import dev.shxzu.valium.event.impl.input.EventMovementInput;
import dev.shxzu.valium.event.impl.network.EventPacket;
import dev.shxzu.valium.event.impl.player.EventSilentRotation;
...
import dev.shxzu.valium.module.modules.player.scaffold.tower.ConstantMotionTower;
import dev.shxzu.valium.module.modules.player.scaffold.tower.NormalTower;
import dev.shxzu.valium.module.modules.player.scaffold.tower.VulcanTower;
...
import dev.shxzu.valium.utils.math.MathUtils;
import dev.shxzu.valium.utils.math.RandomUtil;
import dev.shxzu.valium.utils.mc.*;
import dev.shxzu.valium.utils.rotation.RotationUtils;
...
public class Scaffold extends Module {
    ...
    private void doNormalSprint() {
        if (sprint.getValue()) {
            switch (sprintMode.getMode()) {
                case "Legit":
                    if(MoveUtils.enoughMovementForSprinting()) {
