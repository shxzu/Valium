...
public class PlayerUtil implements Utils {
    ...
    //These new packet formats bro wtf. I miss C03 and C04s..
    public static void damageCubecraft() {
        PacketUtils.sendPacketSilently(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX(), mc.player.getY() + 3.1001, mc.player.getZ(), false));
        PacketUtils.sendPacketSilently(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX(), mc.player.getY(), mc.player.getZ(), false));
        PacketUtils.sendPacketSilently(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX(), mc.player.getY(), mc.player.getZ(), true));
        mc.player.jump();
    }
