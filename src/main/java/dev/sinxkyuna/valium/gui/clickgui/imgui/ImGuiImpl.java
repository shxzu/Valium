package dev.sinxkyuna.valium.gui.clickgui.imgui;

import dev.sinxkyuna.valium.utils.render.ColorUtils;
import imgui.*;
...
public class ImGuiImpl {
    ...
    public static void initialize(final long windowId) {
        ...
        String fontPath = "assets/valium/fonts/proggy_clean.ttf";
