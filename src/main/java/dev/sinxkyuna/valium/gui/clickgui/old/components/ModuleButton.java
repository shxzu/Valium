package dev.sinxkyuna.valium.gui.clickgui.old.components;

import dev.sinxkyuna.valium.gui.clickgui.old.Window;
import dev.sinxkyuna.valium.gui.clickgui.old.components.settings.*;
